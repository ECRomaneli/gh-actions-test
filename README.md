...
To create the artifacts, there is 2 or 3 steps:
- Package (package the project files);
- [DARWIN-ONLY] Unquarantine (Remove quarantine attribute);
- Make (compact the package to final OS files).

The package can also be used without the need of compact it.

### Package

| Description                   | Command                           |
|-------------------------------|-----------------------------------|
| Package for macOS universal   | `npm run package:darwin-universal`|
| Package for macOS x64         | `npm run package:darwin-x64`      |
| Package for macOS arm64       | `npm run package:darwin-arm64`    |
| Package for Linux x64         | `npm run package:linux-x64`       |
| Package for Windows x64       | `npm run package:win32-x64`       |

### [DARWIN-ONLY] Unquarantine

| Description                   | Command                           |
|-------------------------------|-----------------------------------|
| Unquarantine macOS universal   | `npm run unquarantine:darwin-universal`|
| Unquarantine macOS x64         | `npm run unquarantine:darwin-x64`      |
| Unquarantine macOS arm64       | `npm run unquarantine:darwin-arm64`    |
...
| Make for macOS Universal APP (Only Available on MacOS) | `npm run make:darwin-universal`   |
| Make for macOS x64 APP (Zipped App)                    | `npm run make:darwin-x64`         |
| Make for macOS arm64 APP (Zipped App)                  | `npm run make:darwin-arm64`       |
